...
;  1. negative index,  (return empty)
;  2. (index + offset) greater than length, (empty string)
;  3. negative offset (empty string)
  ...
  ; (str.indexof s t i), with  0 <= i <= |s| is the position 
...
; add later replaceAll and replaceRegexp
...
:definition
  ...
  * (str.< String String Bool)
    ...
    Note: The order induced by str.< corresponds to alphabetical order
          for strings composed of characters for the alphabet of 
          a western language such as English:
